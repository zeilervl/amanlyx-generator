...
module.exports = {
    async run(bot, message, args) {
        ...
        if(activityType === "STREAMING") return bot.user.setActivity(activityName, {type: 1, url: "https://www.twitch.tv/play_aman"}).then(() => console.log("Successfully set activity."));
