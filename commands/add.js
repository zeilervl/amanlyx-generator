...
module.exports = {
    async run(bot, message, args) {
        if (message.author.id !== "679613118866784256" && message.author.id !== "694499734534226011" && message.author.id !== "692278475876204565") return message.channel.send("**Unauthorised.**");
